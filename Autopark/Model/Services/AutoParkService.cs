...
{
    public class AutoparkService : AbstractService
    {
        public float AutoparkSquare = 3350.50f;
        public decimal AutoparkCost = 30_000_000_000m;
        private decimal AutoparkBank;

        private GenerateService _generator;

        public AutoparkService(List<Vehicle> transport) : base(transport)
        {
            _generator = new GenerateService();
        }

        public AutoparkService(decimal autoparkBank, List<Vehicle> transport) : base(transport)
        {
        ...
        public AutoparkService(float autoparkSquare, decimal autoparkCost, decimal autoparkBank, List<Vehicle> transport) : base(transport)
        {
